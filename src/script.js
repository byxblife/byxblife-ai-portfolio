document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "nav.work": "Work",
            "nav.contact": "Contact",
            "hero.title": "Designing Intelligence.",
            "hero.subtitle": "Specializing in Advanced Agentic AI & Minimalist Engineering.",
        ...
        zh: {
            ...
            "nav.contact": "聯絡",
            "hero.title": "設計智慧。",
            "hero.subtitle": "專注於進階代理式 AI 與極簡工程美學。",
            "about.title": "關於我",
