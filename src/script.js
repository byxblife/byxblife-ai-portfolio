document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "about.text1": "I am a Product Manager by day. After work, I learn to apply Large Language Models (LLMs) to put ideas into practice, creating usable small tools and workflows to solve small everyday problems.",
            "about.text2": "AI Application Method: Let AI handle repetitive and complex tasks, and users just use the tools to solve problems. The biggest constraint I set for myself is: 'Cannot use any past design tools or techniques—only use text or hand-drawn sketches to build ideas through AI collaboration.'",
