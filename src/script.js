document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "about.text2": "AI Approach: Let AI handle the repetitive and complex tasks, so users can simply focus on using the tools to solve problems.",
        ...
        zh: {
            ...
            "about.text2": "AI應用方式：讓AI處理重複複雜的事、使用者只應用工具解決問題。",
            "about.stats.n_exp": "0.5+",
